...
var NoMetaError = /*#__PURE__*/function (_Error) {
    ...
    value: function parse() {
      ...
      self._stories = entries.reduce(function (acc, _ref6) {
        ...
        if ((0, _csf.isExportStory)(key, self._meta)) {
          var id = (0, _csf.toId)(self._meta.id || self._meta.title, (0, _csf.storyNameFromExport)(key));
