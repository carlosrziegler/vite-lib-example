...
export type Plugin = (this: Stylis, context: Context, content: any, selector: Array<string>, parent: Array<string>, line: number, column: number, length: number, at: number, depth: number) => any;
...
export type Prefix = boolean | ((key: string, value: string, context: PrefixContext) => boolean);
