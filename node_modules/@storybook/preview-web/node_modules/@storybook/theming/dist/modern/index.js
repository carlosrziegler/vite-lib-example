...
const memoize = memoizerific.exports;
const createReset = memoize(1)(({
  typography
}) => ({
  body: {
...
const convert = (inherit = themes[getPreferredColorScheme()]) => {
  const {
    ...
    gridCellSize
        ...
        rest = __rest(inherit, ["base", "colorPrimary", "colorSecondary", "appBg", "appContentBg", "appBorderColor", "appBorderRadius", "fontBase", "fontCode", "textColor", "textInverseColor", "barTextColor", "barSelectedColor", "barBg", "inputBg", "inputBorder", "inputTextColor", "inputBorderRadius", "brandTitle", "brandUrl", "brandImage", "gridCellSize"]);
...
export { ClassNames, Global, ThemeProvider, background, color, convert, create$1 as create, createGlobal, createReset, css, darkenColor as darken, ensure, ignoreSsrWarning, index as isPropValid, jsx, keyframes, lightenColor as lighten, styled, themes, typography, useTheme, withTheme };
