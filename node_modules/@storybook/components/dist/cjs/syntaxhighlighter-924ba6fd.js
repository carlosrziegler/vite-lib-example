...
function createElement(_ref) {
  ...
  if (type === 'text') {
    ...
    return React__default["default"].createElement(TagName, index._extends({
      key: key
    }, props), children);
  }
}
...
function AllLineNumbers(_ref2) {
  ...
  return React__default["default"].createElement("code", {
...
function highlight$1(defaultAstGenerator, defaultStyle) {
  return function SyntaxHighlighter(_ref7) {
    ...
    var allLineNumbers = showLineNumbers ? React__default["default"].createElement(AllLineNumbers, {
    ...
    if (!astGenerator) {
      return React__default["default"].createElement(PreTag, preProps, allLineNumbers, React__default["default"].createElement(CodeTag, codeTagProps, code));
    }
    /*
    ...
    return React__default["default"].createElement(PreTag, preProps, React__default["default"].createElement(CodeTag, codeTagProps, !showInlineLineNumbers && allLineNumbers, renderer({
      rows: rows,
      stylesheet: style,
      useInlineStyles: useInlineStyles
    })));
...
(function (module) {
  ...
  if (typeof index.commonjsGlobal !== 'undefined') {
    index.commonjsGlobal.Prism = Prism;
...
var ctx = typeof globalThis === 'object' ? globalThis : typeof self === 'object' ? self : typeof window === 'object' ? window : typeof index.commonjsGlobal === 'object' ? index.commonjsGlobal : {};
var restore = capture();
ctx.Prism = {
  manual: true,
...
const formatter = index.memoize(2)(code => index.dedent(code));
const {
  navigator,
  document: document$1,
  window: globalWindow
...
const themedSyntax = index.memoize(2)(theme => Object.entries(theme.code || {}).reduce((acc, [key, val]) => Object.assign(Object.assign({}, acc), {
  [`* .${key}`]: val
}), {}));
...
const Code = theming.styled.code({
  flex: 1,
  paddingRight: 0,
  opacity: 1
});
...
const SyntaxHighlighter = _a => {
  var {
    ...
    showLineNumbers = false
      ...
      rest = index.__rest(_a, ["children", "language", "copyable", "bordered", "padded", "format", "className", "showLineNumbers"]);
  ...
  }, React__default["default"].createElement(Scroller, null, React__default["default"].createElement(ReactSyntaxHighlighter, Object.assign({
