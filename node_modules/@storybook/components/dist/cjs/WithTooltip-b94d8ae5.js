...
var toPaddingObject = function toPaddingObject(padding, state) {
  ...
  return mergePaddingObject(typeof padding !== 'number' ? padding : expandToHashMap(padding, index.basePlacements));
};
...
function arrow(_ref) {
  ...
  var isVertical = [index.left, index.right].indexOf(basePlacement) >= 0;
  ...
  var minProp = axis === 'y' ? index.top : index.left;
  var maxProp = axis === 'y' ? index.bottom : index.right;
...
function mapToStyles(_ref2) {
  ...
  if (adaptive) {
    ...
    if (placement === index.top || (placement === index.left || placement === index.right) && variation === index.end) {
      sideY = index.bottom;
    ...
    if (placement === index.left || (placement === index.top || placement === index.bottom) && variation === index.end) {
      sideX = index.right;
...
function getClientRectFromMixedType(element, clippingParent) {
  return clippingParent === index.viewport ? rectToClientRect(getViewportRect(element)) : isElement(clippingParent) ? getInnerBoundingClientRect(clippingParent) : rectToClientRect(getDocumentRect(getDocumentElement(element)));
...
function detectOverflow(state, options) {
  ...
  var _options = options,
      ...
      boundary = _options$boundary === void 0 ? index.clippingParents : _options$boundary,
      _options$rootBoundary = _options.rootBoundary,
      rootBoundary = _options$rootBoundary === void 0 ? index.viewport : _options$rootBoundary,
      _options$elementConte = _options.elementContext,
      elementContext = _options$elementConte === void 0 ? index.popper : _options$elementConte,
      _options$altBoundary = _options.altBoundary,
      altBoundary = _options$altBoundary === void 0 ? false : _options$altBoundary,
      _options$padding = _options.padding,
      padding = _options$padding === void 0 ? 0 : _options$padding;
  var paddingObject = mergePaddingObject(typeof padding !== 'number' ? padding : expandToHashMap(padding, index.basePlacements));
  var altContext = elementContext === index.popper ? index.reference : index.popper;
  ...
  var elementClientRect = elementContext === index.popper ? popperClientRect : referenceClientRect; // positive = overflowing the clipping rect
  ...
  if (elementContext === index.popper && offsetData) {
    var offset = offsetData[placement];
    Object.keys(overflowOffsets).forEach(function (key) {
      var multiply = [index.right, index.bottom].indexOf(key) >= 0 ? 1 : -1;
      var axis = [index.top, index.bottom].indexOf(key) >= 0 ? 'y' : 'x';
...
function computeAutoPlacement(state, options) {
  ...
  var _options = options,
      ...
      allowedAutoPlacements = _options$allowedAutoP === void 0 ? index.placements : _options$allowedAutoP;
  var variation = getVariation(placement);
  var placements = variation ? flipVariations ? index.variationPlacements : index.variationPlacements.filter(function (placement) {
    return getVariation(placement) === variation;
  }) : index.basePlacements;
...
function getExpandedFallbackPlacements(placement) {
  if (getBasePlacement(placement) === index.auto) {
    return [];
  }
...
function flip(_ref) {
  ...
  var placements = [preferredPlacement].concat(fallbackPlacements).reduce(function (acc, placement) {
    return acc.concat(getBasePlacement(placement) === index.auto ? computeAutoPlacement(state, {
      placement: placement,
      boundary: boundary,
      rootBoundary: rootBoundary,
      padding: padding,
  ...
  for (var i = 0; i < placements.length; i++) {
    ...
    var isStartVariation = getVariation(placement) === index.start;
    var isVertical = [index.top, index.bottom].indexOf(_basePlacement) >= 0;
    ...
    var mainVariationSide = isVertical ? isStartVariation ? index.right : index.left : isStartVariation ? index.bottom : index.top;
...
function isAnySideFullyClipped(overflow) {
  return [index.top, index.right, index.bottom, index.left].some(function (side) {
...
function distanceAndSkiddingToXY(placement, rects, offset) {
  ...
  var invertDistance = [index.left, index.top].indexOf(basePlacement) >= 0 ? -1 : 1;
  ...
  return [index.left, index.right].indexOf(basePlacement) >= 0 ? {
    x: distance,
    y: skidding
  } : {
    x: skidding,
...
function offset(_ref2) {
  ...
  var data = index.placements.reduce(function (acc, placement) {
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis) {
    ...
    var mainSide = mainAxis === 'y' ? index.top : index.left;
    var altSide = mainAxis === 'y' ? index.bottom : index.right;
    var len = mainAxis === 'y' ? 'height' : 'width';
    var offset = popperOffsets[mainAxis];
    var min$1 = offset + overflow[mainSide];
    var max$1 = offset - overflow[altSide];
    var additive = tether ? -popperRect[len] / 2 : 0;
    var minLen = variation === index.start ? referenceRect[len] : popperRect[len];
    var maxLen = variation === index.start ? -popperRect[len] : -referenceRect[len]; // We need to include the arrow in the calculation so the arrow doesn't go
  ...
  if (checkAltAxis) {
    ...
    var _mainSide = mainAxis === 'x' ? index.top : index.left;

    var _altSide = mainAxis === 'x' ? index.bottom : index.right;
    ...
    var isOriginSide = [index.top, index.left].indexOf(basePlacement) !== -1;
...
function orderModifiers(modifiers) {
  ...
  return index.modifierPhases.reduce(function (acc, phase) {
  ...
  modifiers.forEach(function (modifier) {
    ...
    .filter(function (value, index, self) {
      ...
      switch (key) {
        ...
        case 'phase':
          if (index.modifierPhases.indexOf(modifier.phase) < 0) {
            console.error(format(INVALID_MODIFIER_ERROR, modifier.name, '"phase"', "either " + index.modifierPhases.join(', '), "\"" + String(modifier.phase) + "\""));
          }
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (process.env.NODE_ENV !== "production") {
          ...
          if (getBasePlacement(state.options.placement) === index.auto) {
...
var Tooltip$1 = /*#__PURE__*/function (_Component) {
  index._inheritsLoose(Tooltip, _Component);
  ...
  function Tooltip() {
    ...
    _this.getArrowProps = function (props) {
      ...
      return index._extends({}, props, {
        style: index._extends({}, props.style, _this.props.arrowProps.style)
      });
    };
    ...
    _this.getTooltipProps = function (props) {
      ...
      return index._extends({}, props, _this.isTriggeredBy('hover') && {
        ...
        style: index._extends({}, props.style, _this.props.style)
      });
    };
...
var TooltipTrigger = /*#__PURE__*/function (_Component) {
  index._inheritsLoose(TooltipTrigger, _Component);
  ...
  function TooltipTrigger() {
    ...
    _this.getTriggerProps = function (props) {
      ...
      return index._extends({}, props, _this.isTriggeredBy('click') && {
      ...
      }, _this.isTriggeredBy('hover') && index._extends({
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        restProps = index._objectWithoutPropertiesLoose(_this$props, ["children", "tooltip", "placement", "trigger", "getTriggerRef", "modifiers", "closeOnReferenceHidden", "usePortal", "portalContainer", "followCursor", "getTooltipRef", "mutationObserverOptions"]);

    var popper = /*#__PURE__*/React__default["default"].createElement(Popper, index._extends({
      ...
      return /*#__PURE__*/React__default["default"].createElement(Tooltip$1, index._extends({
...
const match = index.memoize(1000)((requests, actual, value, fallback = 0) => actual.split('-')[0] === requests ? value : fallback);
...
const Arrow = theming.styled.div({
  ...
  borderTopColor: match('top', placement, theme.color[color] || color || theme.base === 'light' ? theming.lighten(theme.background.app) : theming.darken(theme.background.app), 'transparent'),
  borderBottomColor: match('bottom', placement, theme.color[color] || color || theme.base === 'light' ? theming.lighten(theme.background.app) : theming.darken(theme.background.app), 'transparent'),
  borderLeftColor: match('left', placement, theme.color[color] || color || theme.base === 'light' ? theming.lighten(theme.background.app) : theming.darken(theme.background.app), 'transparent'),
  borderRightColor: match('right', placement, theme.color[color] || color || theme.base === 'light' ? theming.lighten(theme.background.app) : theming.darken(theme.background.app), 'transparent')
}));
const Wrapper = theming.styled.div(({
  ...
  background: theme.color[color] || color || theme.base === 'light' ? theming.lighten(theme.background.app) : theming.darken(theme.background.app),
  filter: `
...
const Tooltip = _a => {
  var {
    ...
    color
      ...
      props = index.__rest(_a, ["placement", "hasChrome", "children", "arrowProps", "tooltipRef", "arrowRef", "color"]);

  return React__default["default"].createElement(Wrapper, Object.assign({
    hasChrome: hasChrome,
    placement: placement,
    ref: tooltipRef
  }, props, {
    color: color
  }), hasChrome && React__default["default"].createElement(Arrow, Object.assign({
    placement: placement,
    ref: arrowRef
  }, arrowProps, {
    color: color
...
const {
  document: document$1
} = index.window_1; // A target that doesn't speak popper

const TargetContainer = theming.styled.div`
  display: inline-block;
  cursor: ${props => props.mode === 'hover' ? 'default' : 'pointer'};
`;
const TargetSvgContainer = theming.styled.g`
  cursor: ${props => props.mode === 'hover' ? 'default' : 'pointer'};
...
const WithTooltipPure = _a => {
  var {
    ...
    onVisibilityChange
      ...
      props = index.__rest(_a, ["svg", "trigger", "closeOnClick", "placement", "modifiers", "hasChrome", "tooltip", "children", "tooltipShown", "onVisibilityChange"]);

  const Container = svg ? TargetSvgContainer : TargetContainer;
  return React__default["default"].createElement(TooltipTrigger$1, {
    placement: placement,
    trigger: trigger,
    modifiers: modifiers,
    ...
    }) => React__default["default"].createElement(Tooltip, Object.assign({
      hasChrome: hasChrome,
      placement: tooltipPlacement,
  ...
  React__default["default"].createElement(Container, Object.assign({
    ref: triggerRef
...
const WithToolTipState = _a => {
  var {
    ...
    onVisibilityChange: onChange
      ...
      rest = index.__rest(_a, ["startOpen", "onVisibilityChange"]);

  const [tooltipShown, setTooltipShown] = React.useState(startOpen || false);
  const onVisibilityChange = React.useCallback(visibility => {
  ...
  return React__default["default"].createElement(WithTooltipPure, Object.assign({}, rest, {
    tooltipShown: tooltipShown,
    onVisibilityChange: onVisibilityChange
  }));
};
...
exports.WithTooltip = WithToolTipState;
