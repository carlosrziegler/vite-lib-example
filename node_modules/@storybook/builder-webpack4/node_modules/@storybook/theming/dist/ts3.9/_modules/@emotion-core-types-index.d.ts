...
import css, { Interpolation, SerializedStyles } from "./@emotion-css-types-index";
import { Keyframes } from "./@emotion-serialize-types-index";
import { ClassAttributes, ComponentClass, Context, Provider, FC, ReactElement, ReactNode, Ref, createElement } from 'react';
export { ArrayInterpolation, ComponentSelector, CSSObject, FunctionInterpolation, ObjectInterpolation } from "./@emotion-css-types-index";
 ...
 * JSX generic are supported only after TS@2.9
 */
export function ClassNames<Theme = any>(props: ClassNamesProps<Theme>): ReactElement;
