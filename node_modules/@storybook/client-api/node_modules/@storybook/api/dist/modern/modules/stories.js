const _excluded = ["kind", "story", "storyId"],
      _excluded2 = ["id"];
...
import { STORY_PREPARED, UPDATE_STORY_ARGS, RESET_STORY_ARGS, STORY_ARGS_UPDATED, STORY_CHANGED, SELECT_STORY, SET_STORIES, STORY_SPECIFIED, STORY_INDEX_INVALIDATED, CONFIG_ERROR } from '@storybook/core-events';
    ...
    fullAPI.on(STORY_PREPARED, function handler(_ref2) {
      let {
        id
          ...
          update = _objectWithoutPropertiesLoose(_ref2, _excluded2);
