...
import { ModuleImportFn, Selection, Story, StoryStore, StorySpecifier, StoryIndex } from '@storybook/store';
...
declare type HTMLStoryRender<TFramework extends AnyFramework> = StoryRender<HTMLElement, TFramework>;
export declare class PreviewWeb<TFramework extends AnyFramework> {
    ...
    teardownRender(render: HTMLStoryRender<TFramework> | DocsRender<TFramework>, { viewModeChanged }?: {
