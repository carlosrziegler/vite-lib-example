...
var _DocsRender = require("./DocsRender");
...
var PreviewWeb = /*#__PURE__*/function () {
  ...
  _createClass(PreviewWeb, [{
    ...
    value: function setupListeners() {
      ...
      this.channel.on(_coreEvents.default.FORCE_RE_RENDER, this.onForceReRender.bind(this));
      this.channel.on(_coreEvents.default.FORCE_REMOUNT, this.onForceRemount.bind(this));
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 4:
                if (!(this.currentRender instanceof _DocsRender.DocsRender)) {
                  _context7.next = 7;
                  break;
                }
        ...
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 14:
                storyRender = new _StoryRender.StoryRender(this.channel, this.storyStore, this.renderToDOM, this.mainStoryCallbacks(storyId), storyId, 'story'); // We need to store this right away, so if the story changes during
              ...
              case 22:
                ...
                if (!(_context12.t0 !== _StoryRender.PREPARE_ABORTED)) {
                  _context12.next = 28;
                  break;
                }
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 2:
                ...
                throw new Error((0, _tsDedent.default)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["Failed to initialize Storybook.\n      \n      Do you have an error in your `preview.js`? Check your Storybook's browser console for errors."], ["Failed to initialize Storybook.\n      \n      Do you have an error in your \\`preview.js\\`? Check your Storybook's browser console for errors."]))));

              case 4:
                if (!((_global$FEATURES7 = _global.default.FEATURES) !== null && _global$FEATURES7 !== void 0 && _global$FEATURES7.storyStoreV7)) {
                  _context15.next = 7;
                  break;
                }
