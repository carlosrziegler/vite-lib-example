...
exports.remarkTransclusion = void 0;
const importRE = /^import ['"](.+)['"]\s*$/;
const mdxRE = /\.mdx?$/;
function remarkTransclusion({ resolve, readFile, getCompiler, importMap, astCache }) {
...
exports.remarkTransclusion = remarkTransclusion;
