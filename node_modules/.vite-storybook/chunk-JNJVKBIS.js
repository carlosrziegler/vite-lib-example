...
var $3, DESCRIPTORS, global, uncurryThis, hasOwn, isCallable, isPrototypeOf, toString, defineProperty, copyConstructorProperties, NativeSymbol, SymbolPrototype, EmptyStringDescriptionStore, SymbolWrapper, NATIVE_SYMBOL, thisSymbolValue, symbolDescriptiveString, regexp, replace, stringSlice;
...
var DESCRIPTORS2, FUNCTION_NAME_EXISTS, uncurryThis2, defineProperty2, FunctionPrototype, functionToString, nameRE, regExpExec, NAME;
var init_es_function_name = __esm({
  "node_modules/core-js/modules/es.function.name.js"() {
    ...
    regExpExec = uncurryThis2(nameRE.exec);
    NAME = "name";
...
var $4, from, checkCorrectnessOfIteration, INCORRECT_ITERATION;
...
var $5, $includes, fails, addToUnscopables, BROKEN_ON_SPARSE;
...
var $6, uncurryThis3, notARegExp, requireObjectCoercible, toString2, correctIsRegExpLogic, stringIndexOf;
var init_es_string_includes = __esm({
  "node_modules/core-js/modules/es.string.includes.js"() {
    ...
    stringIndexOf = uncurryThis3("".indexOf);
...
//# sourceMappingURL=chunk-JNJVKBIS.js.map
