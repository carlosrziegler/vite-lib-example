...
var require_array_buffer = __commonJS({
  "node_modules/core-js/internals/array-buffer.js"(exports, module) {
    ...
    var arraySlice3 = require_array_slice_simple();
    ...
    var RangeError3 = global9.RangeError;
    var fill2 = uncurryThis7(arrayFill);
    var reverse2 = uncurryThis7([].reverse);
    ...
    var get2 = function(view, count, index3, isLittleEndian) {
      var intIndex = toIndex(index3);
      var store = getInternalState(view);
      if (intIndex + count > store.byteLength)
        throw RangeError3(WRONG_INDEX);
      var bytes = getInternalState(store.buffer).bytes;
      var start2 = intIndex + store.byteOffset;
      var pack = arraySlice3(bytes, start2, start2 + count);
      return isLittleEndian ? pack : reverse2(pack);
    };
    var set2 = function(view, count, index3, conversion, value2, isLittleEndian) {
      var intIndex = toIndex(index3);
      var store = getInternalState(view);
      if (intIndex + count > store.byteLength)
        throw RangeError3(WRONG_INDEX);
    ...
    if (!NATIVE_ARRAY_BUFFER) {
      ...
      defineBuiltIns(DataViewPrototype, {
        ...
        setInt8: function setInt8(byteOffset, value2) {
          set2(this, 1, byteOffset, packInt8, value2);
        },
        setUint8: function setUint8(byteOffset, value2) {
          set2(this, 1, byteOffset, packInt8, value2);
        },
        setInt16: function setInt16(byteOffset, value2) {
          set2(this, 2, byteOffset, packInt16, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setUint16: function setUint16(byteOffset, value2) {
          set2(this, 2, byteOffset, packInt16, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setInt32: function setInt32(byteOffset, value2) {
          set2(this, 4, byteOffset, packInt32, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setUint32: function setUint32(byteOffset, value2) {
          set2(this, 4, byteOffset, packInt32, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setFloat32: function setFloat32(byteOffset, value2) {
          set2(this, 4, byteOffset, packFloat32, value2, arguments.length > 2 ? arguments[2] : void 0);
        },
        setFloat64: function setFloat64(byteOffset, value2) {
          set2(this, 8, byteOffset, packFloat64, value2, arguments.length > 2 ? arguments[2] : void 0);
        }
      });
    } else {
      ...
      if (!fails8(function() {
        ...
        for (keys3 = getOwnPropertyNames(NativeArrayBuffer2), j2 = 0; keys3.length > j2; ) {
          if (!((key = keys3[j2++]) in $ArrayBuffer)) {
      ...
      $setInt8 = uncurryThis7(DataViewPrototype.setInt8);
    ...
    var testView;
    var $setInt8;
    setToStringTag4($ArrayBuffer, ARRAY_BUFFER2);
    setToStringTag4($DataView, DATA_VIEW);
    module.exports = {
...
var require_es_string_trim_right = __commonJS({
  "node_modules/core-js/modules/es.string.trim-right.js"() {
    ...
    $8({ target: "String", proto: true, name: "trimEnd", forced: "".trimRight !== trimEnd2 }, {
      trimRight: trimEnd2
    });
  }
});
...
var require_array_buffer_view_core = __commonJS({
  "node_modules/core-js/internals/array-buffer-view-core.js"(exports, module) {
    ...
    var getInternalState = InternalStateModule.get;
    var Int8Array4 = global9.Int8Array;
    var Int8ArrayPrototype2 = Int8Array4 && Int8Array4.prototype;
    var Uint8ClampedArray2 = global9.Uint8ClampedArray;
    var Uint8ClampedArrayPrototype = Uint8ClampedArray2 && Uint8ClampedArray2.prototype;
    var TypedArray2 = Int8Array4 && getPrototypeOf2(Int8Array4);
    var TypedArrayPrototype2 = Int8ArrayPrototype2 && getPrototypeOf2(Int8ArrayPrototype2);
    var ObjectPrototype = Object.prototype;
    var TypeError2 = global9.TypeError;
    var TO_STRING_TAG = wellKnownSymbol2("toStringTag");
    var TYPED_ARRAY_TAG = uid("TYPED_ARRAY_TAG");
    var TYPED_ARRAY_CONSTRUCTOR = "TypedArrayConstructor";
    var NATIVE_ARRAY_BUFFER_VIEWS = NATIVE_ARRAY_BUFFER && !!setPrototypeOf && classof2(global9.opera) !== "Opera";
    ...
    var aTypedArray23 = function(it2) {
      if (isTypedArray2(it2))
        return it2;
      throw TypeError2("Target is not a typed array");
    };
    var aTypedArrayConstructor = function(C2) {
      if (isCallable(C2) && (!setPrototypeOf || isPrototypeOf(TypedArray2, C2)))
        return C2;
      throw TypeError2(tryToString(C2) + " is not a typed array constructor");
    };
    var exportTypedArrayMethod24 = function(KEY2, property2, forced, options) {
      if (!DESCRIPTORS)
        return;
      if (forced)
        for (var ARRAY2 in TypedArrayConstructorsList) {
          var TypedArrayConstructor = global9[ARRAY2];
          if (TypedArrayConstructor && hasOwn2(TypedArrayConstructor.prototype, KEY2))
            try {
              delete TypedArrayConstructor.prototype[KEY2];
            } catch (error2) {
              try {
                TypedArrayConstructor.prototype[KEY2] = property2;
              } catch (error22) {
              }
            }
        }
      if (!TypedArrayPrototype2[KEY2] || forced) {
        defineBuiltIn(TypedArrayPrototype2, KEY2, forced ? property2 : NATIVE_ARRAY_BUFFER_VIEWS && Int8ArrayPrototype2[KEY2] || property2, options);
      }
    };
    var exportTypedArrayStaticMethod = function(KEY2, property2, forced) {
      var ARRAY2, TypedArrayConstructor;
      if (!DESCRIPTORS)
        return;
      if (setPrototypeOf) {
        if (forced)
          for (ARRAY2 in TypedArrayConstructorsList) {
            TypedArrayConstructor = global9[ARRAY2];
            if (TypedArrayConstructor && hasOwn2(TypedArrayConstructor, KEY2))
              try {
                delete TypedArrayConstructor[KEY2];
              } catch (error2) {
              }
          }
        if (!TypedArray2[KEY2] || forced) {
          try {
            return defineBuiltIn(TypedArray2, KEY2, forced ? property2 : NATIVE_ARRAY_BUFFER_VIEWS && TypedArray2[KEY2] || property2);
          } catch (error2) {
          }
        } else
          return;
      ...
      for (ARRAY2 in TypedArrayConstructorsList) {
        ...
        if (TypedArrayConstructor && (!TypedArrayConstructor[KEY2] || forced)) {
          defineBuiltIn(TypedArrayConstructor, KEY2, property2);
        }
      }
    };
    for (NAME in TypedArrayConstructorsList) {
      Constructor = global9[NAME];
    ...
    if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable(TypedArray2) || TypedArray2 === Function.prototype) {
      TypedArray2 = function TypedArray3() {
        throw TypeError2("Incorrect invocation");
      };
      if (NATIVE_ARRAY_BUFFER_VIEWS)
        for (NAME in TypedArrayConstructorsList) {
          if (global9[NAME])
            setPrototypeOf(global9[NAME], TypedArray2);
        }
    }
    if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype2 || TypedArrayPrototype2 === ObjectPrototype) {
      TypedArrayPrototype2 = TypedArray2.prototype;
      if (NATIVE_ARRAY_BUFFER_VIEWS)
        for (NAME in TypedArrayConstructorsList) {
          if (global9[NAME])
            setPrototypeOf(global9[NAME].prototype, TypedArrayPrototype2);
        }
    }
    ...
    if (DESCRIPTORS && !hasOwn2(TypedArrayPrototype2, TO_STRING_TAG)) {
      TYPED_ARRAY_TAG_REQUIRED = true;
      defineProperty2(TypedArrayPrototype2, TO_STRING_TAG, { get: function() {
        return isObject2(this) ? this[TYPED_ARRAY_TAG] : void 0;
      } });
      for (NAME in TypedArrayConstructorsList)
        if (global9[NAME]) {
          createNonEnumerableProperty(global9[NAME], TYPED_ARRAY_TAG, NAME);
        }
    }
    module.exports = {
...
var require_typed_array_constructors_require_wrappers = __commonJS({
  "node_modules/core-js/internals/typed-array-constructors-require-wrappers.js"(exports, module) {
    ...
    var ArrayBuffer3 = global9.ArrayBuffer;
    var Int8Array4 = global9.Int8Array;
    module.exports = !NATIVE_ARRAY_BUFFER_VIEWS || !fails8(function() {
      Int8Array4(1);
    }) || !fails8(function() {
      new Int8Array4(-1);
...
var require_to_positive_integer = __commonJS({
  "node_modules/core-js/internals/to-positive-integer.js"(exports, module) {
    ...
    var $RangeError = RangeError;
    module.exports = function(it2) {
      var result2 = toIntegerOrInfinity(it2);
      if (result2 < 0)
...
var require_is_big_int_array = __commonJS({
  "node_modules/core-js/internals/is-big-int-array.js"(exports, module) {
    ...
    var classof2 = require_classof();
    var uncurryThis7 = require_function_uncurry_this();
    var slice4 = uncurryThis7("".slice);
    module.exports = function(it2) {
      return slice4(classof2(it2), 0, 3) === "Big";
    };
  }
});
  ...
  "node_modules/core-js/internals/to-big-int.js"(exports, module) {
    ...
    module.exports = function(argument) {
      ...
      if (typeof prim == "number")
        throw $TypeError2("Can't convert number to bigint");
      return BigInt(prim);
    };
  }
});
...
var require_typed_array_from = __commonJS({
  "node_modules/core-js/internals/typed-array-from.js"(exports, module) {
    ...
    module.exports = function from(source) {
      ...
      var i2, length, result2, thisIsBigIntArray, value2, step, iterator, next;
      ...
      length = lengthOfArrayLike2(O2);
      result2 = new (aTypedArrayConstructor(C2))(length);
      thisIsBigIntArray = isBigIntArray(result2);
      for (i2 = 0; length > i2; i2++) {
        value2 = mapping ? mapfn(O2[i2], i2) : O2[i2];
        result2[i2] = thisIsBigIntArray ? toBigInt2(value2) : +value2;
      }
      return result2;
    };
  }
...
var require_typed_array_constructor = __commonJS({
  "node_modules/core-js/internals/typed-array-constructor.js"(exports, module) {
    ...
    var TypedArray2 = ArrayBufferViewCore23.TypedArray;
    var TypedArrayPrototype2 = ArrayBufferViewCore23.TypedArrayPrototype;
    var aTypedArrayConstructor = ArrayBufferViewCore23.aTypedArrayConstructor;
    var isTypedArray2 = ArrayBufferViewCore23.isTypedArray;
    ...
    var fromList = function(C2, list) {
      ...
      var result2 = new C2(length);
      while (length > index3)
        result2[index3] = list[index3++];
      return result2;
    };
    ...
    var isArrayBuffer = function(it2) {
      var klass;
      return isPrototypeOf(ArrayBufferPrototype, it2) || (klass = classof2(it2)) == "ArrayBuffer" || klass == "SharedArrayBuffer";
    };
    ...
    if (DESCRIPTORS) {
      ...
      module.exports = function(TYPE, wrapper, CLAMPED) {
        ...
        var GETTER = "get" + TYPE;
        var SETTER = "set" + TYPE;
        var NativeTypedArrayConstructor = global9[CONSTRUCTOR_NAME];
        ...
        var setter = function(that, index3, value2) {
          var data = getInternalState(that);
          if (CLAMPED)
            value2 = (value2 = round(value2)) < 0 ? 0 : value2 > 255 ? 255 : value2 & 255;
          data.view[SETTER](index3 * BYTES + data.byteOffset, value2, true);
        };
        var addElement = function(that, index3) {
          nativeDefineProperty(that, index3, {
            ...
            set: function(value2) {
              return setter(this, index3, value2);
            },
            enumerable: true
          });
        };
        if (!NATIVE_ARRAY_BUFFER_VIEWS) {
          TypedArrayConstructor = wrapper(function(that, data, offset, $length) {
            ...
            if (!isObject2(data)) {
              ...
              return call3(typedArrayFrom, TypedArrayConstructor, data);
            }
          ...
          if (setPrototypeOf)
            setPrototypeOf(TypedArrayConstructor, TypedArray2);
          TypedArrayConstructorPrototype = TypedArrayConstructor.prototype = create(TypedArrayPrototype2);
        ...
        var FORCED3 = TypedArrayConstructor != NativeTypedArrayConstructor;
        exported[CONSTRUCTOR_NAME] = TypedArrayConstructor;
        $8({ global: true, constructor: true, forced: FORCED3, sham: !NATIVE_ARRAY_BUFFER_VIEWS }, exported);
...
var require_array_copy_within = __commonJS({
  "node_modules/core-js/internals/array-copy-within.js"(exports, module) {
    ...
    var min = Math.min;
    module.exports = [].copyWithin || function copyWithin2(target, start2) {
      var O2 = toObject(this);
      var len = lengthOfArrayLike2(O2);
      var to = toAbsoluteIndex2(target, len);
      var from = toAbsoluteIndex2(start2, len);
      var end2 = arguments.length > 2 ? arguments[2] : void 0;
      var count = min((end2 === void 0 ? len : toAbsoluteIndex2(end2, len)) - from, len - to);
      var inc = 1;
...
var require_array_from_constructor_and_list = __commonJS({
  "node_modules/core-js/internals/array-from-constructor-and-list.js"(exports, module) {
    ...
    module.exports = function(Constructor, list) {
      var index3 = 0;
      var length = lengthOfArrayLike2(list);
...
var require_typed_array_species_constructor = __commonJS({
  "node_modules/core-js/internals/typed-array-species-constructor.js"(exports, module) {
    ...
    var aTypedArrayConstructor = ArrayBufferViewCore23.aTypedArrayConstructor;
    var getTypedArrayConstructor = ArrayBufferViewCore23.getTypedArrayConstructor;
...
var require_typed_array_from_species_and_list = __commonJS({
  "node_modules/core-js/internals/typed-array-from-species-and-list.js"(exports, module) {
    ...
    var typedArraySpeciesConstructor4 = require_typed_array_species_constructor();
    module.exports = function(instance, list) {
      return arrayFromConstructorAndList(typedArraySpeciesConstructor4(instance), list);
    };
  }
});
...
var require_array_last_index_of = __commonJS({
  "node_modules/core-js/internals/array-last-index-of.js"(exports, module) {
    ...
    var FORCED3 = NEGATIVE_ZERO || !STRICT_METHOD;
    module.exports = FORCED3 ? function lastIndexOf2(searchElement) {
      if (NEGATIVE_ZERO)
        return apply3($lastIndexOf2, this, arguments) || 0;
      var O2 = toIndexedObject2(this);
      var length = lengthOfArrayLike2(O2);
      var index3 = length - 1;
      if (arguments.length > 1)
        index3 = min(index3, toIntegerOrInfinity(arguments[1]));
      if (index3 < 0)
        index3 = length + index3;
      for (; index3 >= 0; index3--)
        if (index3 in O2 && O2[index3] === searchElement)
          return index3 || 0;
      return -1;
    } : $lastIndexOf2;
  }
  ...
  "node_modules/core-js/internals/array-reduce.js"(exports, module) {
    ...
    var createMethod = function(IS_RIGHT) {
      return function(that, callbackfn, argumentsLength, memo2) {
        ...
        for (; IS_RIGHT ? index3 >= 0 : length > index3; index3 += i2)
          if (index3 in self2) {
            memo2 = callbackfn(memo2, self2[index3], index3, O2);
          }
        return memo2;
      };
    };
...
var require_error_stack_clear = __commonJS({
  "node_modules/core-js/internals/error-stack-clear.js"(exports, module) {
    ...
    var uncurryThis7 = require_function_uncurry_this();
    var $Error = Error;
    var replace2 = uncurryThis7("".replace);
...
var require_es_aggregate_error_constructor = __commonJS({
  "node_modules/core-js/modules/es.aggregate-error.constructor.js"() {
    ...
    var $AggregateError = function AggregateError2(errors, message) {
      ...
      var errorsArray = [];
      iterate(errors, push2, { that: errorsArray });
    ...
    $8({ global: true, constructor: true, arity: 2 }, {
...
// node_modules/@storybook/components/dist/esm/index-48cdcb86.js
init_define_import_meta_env();
...
exportTypedArrayMethod3("fill", function fill(value2) {
  var length = arguments.length;
  aTypedArray3(this);
  var actualValue = slice(classof(this), 0, 3) === "Big" ? toBigInt(value2) : +value2;
...
exportTypedArrayMethod4("filter", function filter(callbackfn) {
  var list = $filter(aTypedArray4(this), callbackfn, arguments.length > 1 ? arguments[1] : void 0);
...
exportTypedArrayMethod5("find", function find(predicate) {
  return $find(aTypedArray5(this), predicate, arguments.length > 1 ? arguments[1] : void 0);
});
...
exportTypedArrayMethod6("findIndex", function findIndex(predicate) {
  return $findIndex(aTypedArray6(this), predicate, arguments.length > 1 ? arguments[1] : void 0);
});
...
exportTypedArrayMethod8("includes", function includes(searchElement) {
  return $includes(aTypedArray8(this), searchElement, arguments.length > 1 ? arguments[1] : void 0);
});
...
var arrayValues = uncurryThis3(ArrayIterators.values);
var arrayKeys = uncurryThis3(ArrayIterators.keys);
var arrayEntries = uncurryThis3(ArrayIterators.entries);
...
exportTypedArrayMethod10("entries", function entries() {
  return arrayEntries(aTypedArray10(this));
}, GENERIC);
exportTypedArrayMethod10("keys", function keys() {
...
exportTypedArrayMethod11("join", function join(separator) {
...
exportTypedArrayMethod12("lastIndexOf", function lastIndexOf(searchElement) {
  var length = arguments.length;
  return apply($lastIndexOf, aTypedArray12(this), length > 1 ? [searchElement, arguments[1]] : [searchElement]);
});
...
exportTypedArrayMethod13("map", function map(mapfn) {
  return $map(aTypedArray13(this), mapfn, arguments.length > 1 ? arguments[1] : void 0, function(O2, length) {
...
var RangeError2 = global4.RangeError;
var Int8Array2 = global4.Int8Array;
...
var WORKS_WITH_OBJECTS_AND_GEERIC_ON_TYPED_ARRAYS = !fails3(function() {
  var array2 = new Uint8ClampedArray(2);
  call2($set, array2, { length: 1, 0: 3 }, 1);
  return array2[1] !== 3;
});
var TO_OBJECT_BUG = WORKS_WITH_OBJECTS_AND_GEERIC_ON_TYPED_ARRAYS && ArrayBufferViewCore17.NATIVE_ARRAY_BUFFER_VIEWS && fails3(function() {
...
exportTypedArrayMethod17("set", function set(arrayLike) {
  ...
  var src2 = toIndexedObject(arrayLike);
  if (WORKS_WITH_OBJECTS_AND_GEERIC_ON_TYPED_ARRAYS)
    return call2($set, this, src2, offset);
  var length = this.length;
  var len = lengthOfArrayLike(src2);
  var index3 = 0;
  if (len + offset > length)
    throw RangeError2("Wrong length");
  while (index3 < len)
    this[offset + index3] = src2[index3++];
}, !WORKS_WITH_OBJECTS_AND_GEERIC_ON_TYPED_ARRAYS || TO_OBJECT_BUG);

// node_modules/core-js/modules/es.typed-array.slice.js
init_define_import_meta_env();
var ArrayBufferViewCore18 = require_array_buffer_view_core();
var typedArraySpeciesConstructor2 = require_typed_array_species_constructor();
...
var FORCED = fails4(function() {
  new Int8Array(1).slice();
});
exportTypedArrayMethod18("slice", function slice2(start2, end2) {
  var list = arraySlice(aTypedArray18(this), start2, end2);
  var C2 = typedArraySpeciesConstructor2(this);
  var index3 = 0;
  var length = list.length;
  var result2 = new C2(length);
  while (length > index3)
...
var Uint16Array2 = global5.Uint16Array;
var nativeSort = Uint16Array2 && uncurryThis5(Uint16Array2.prototype.sort);
var ACCEPT_INCORRECT_ARGUMENTS = !!nativeSort && !(fails5(function() {
  nativeSort(new Uint16Array2(2), null);
}) && fails5(function() {
  nativeSort(new Uint16Array2(2), {});
}));
var STABLE_SORT = !!nativeSort && !fails5(function() {
  if (V8)
    return V8 < 74;
  if (FF)
    return FF < 67;
  ...
  for (index3 = 0; index3 < 516; index3++) {
    mod = index3 % 4;
    array2[index3] = 515 - index3;
    expected[index3] = index3 - 2 * mod + 3;
  }
  nativeSort(array2, function(a3, b2) {
    return (a3 / 4 | 0) - (b2 / 4 | 0);
  });
  for (index3 = 0; index3 < 516; index3++) {
    if (array2[index3] !== expected[index3])
      return true;
  }
});
...
exportTypedArrayMethod20("sort", function sort(comparefn) {
  if (comparefn !== void 0)
    aCallable(comparefn);
  if (STABLE_SORT)
    return nativeSort(this, comparefn);
  return internalSort(aTypedArray20(this), getSortCompare(comparefn));
...
var typedArraySpeciesConstructor3 = require_typed_array_species_constructor();
...
exportTypedArrayMethod21("subarray", function subarray(begin, end2) {
  ...
  var C2 = typedArraySpeciesConstructor3(O2);
  return new C2(
    O2.buffer,
...
var Int8Array3 = global6.Int8Array;
...
var TO_LOCALE_STRING_BUG = !!Int8Array3 && fails6(function() {
  $toLocaleString.call(new Int8Array3(1));
});
var FORCED2 = fails6(function() {
...
var Uint8Array3 = global7.Uint8Array;
...
createTypedArrayConstructor2("Float32", function(init) {
...
createTypedArrayConstructor3("Float64", function(init) {
...
createTypedArrayConstructor4("Int8", function(init) {
  return function Int8Array4(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});
...
init_define_import_meta_env();
var createTypedArrayConstructor5 = require_typed_array_constructor();
createTypedArrayConstructor5("Int16", function(init) {
...
init_define_import_meta_env();
var createTypedArrayConstructor6 = require_typed_array_constructor();
createTypedArrayConstructor6("Int32", function(init) {
...
init_define_import_meta_env();
var createTypedArrayConstructor7 = require_typed_array_constructor();
createTypedArrayConstructor7("Uint8", function(init) {
...
init_define_import_meta_env();
var createTypedArrayConstructor8 = require_typed_array_constructor();
createTypedArrayConstructor8("Uint16", function(init) {
...
init_define_import_meta_env();
var createTypedArrayConstructor9 = require_typed_array_constructor();
createTypedArrayConstructor9("Uint32", function(init) {
...
setToStringTag2(global8.JSON, "JSON", true);
...
$4({ target: "Reflect", stat: true, sham: !CORRECT_PROTOTYPE_GETTER }, {
...
function parseToRgb(color) {
  ...
  if (rgbaMatched) {
    return { red: parseInt("" + rgbaMatched[1], 10), green: parseInt("" + rgbaMatched[2], 10), blue: parseInt("" + rgbaMatched[3], 10), alpha: parseFloat("" + rgbaMatched[4]) };
  }
  ...
  if (hslaMatched) {
    ...
    return { red: parseInt("" + _hslRgbMatched[1], 10), green: parseInt("" + _hslRgbMatched[2], 10), blue: parseInt("" + _hslRgbMatched[3], 10), alpha: parseFloat("" + hslaMatched[4]) };
  }
...
function opacify(amount, color) {
  ...
  var colorWithAlpha = _extends({}, parsedColor, { alpha: guard(0, 1, (alpha2 * 100 + parseFloat(amount) * 100) / 100) });
...
function transparentize(amount, color) {
  ...
  var parsedColor = parseToRgb(color);
  var alpha2 = typeof parsedColor.alpha === "number" ? parsedColor.alpha : 1;
  var colorWithAlpha = _extends({}, parsedColor, { alpha: guard(0, 1, +(alpha2 * 100 - parseFloat(amount) * 100).toFixed(2) / 100) });
  return rgba(colorWithAlpha);
}
...
var LazySyntaxHighlighter = (0, import_react.lazy)(function() {
  return import("./syntaxhighlighter-468ee8fe-XQSTPL5K.js");
});
var SyntaxHighlighter = function SyntaxHighlighter2(props) {
  return import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", null) }, import_react.default.createElement(LazySyntaxHighlighter, Object.assign({}, props)));
};
...
var SourceSkeletonPlaceholder = styled.div(function(_ref10) {
  ...
  return { animation: "".concat(theme.animation.glow, " 1.5s ease-in-out infinite"), background: theme.appBorderColor, height: 17, marginTop: 1, width: "60%", "&:first-child": { margin: 0 } };
});
...
var DefaultCodeBlock = styled.code(function(_ref11) {
...
var H1 = styled.h1(withReset, headerCommon, function(_ref12) {
  var theme = _ref12.theme;
  return { fontSize: "".concat(theme.typography.size.l1, "px"), fontWeight: theme.typography.weight.black };
});
var H2 = styled.h2(withReset, headerCommon, function(_ref13) {
...
var H3 = styled.h3(withReset, headerCommon, function(_ref14) {
  var theme = _ref14.theme;
  return { fontSize: "".concat(theme.typography.size.m1, "px") };
});
var H4 = styled.h4(withReset, headerCommon, function(_ref15) {
  var theme = _ref15.theme;
  return { fontSize: "".concat(theme.typography.size.s3, "px") };
});
var H5 = styled.h5(withReset, headerCommon, function(_ref16) {
  var theme = _ref16.theme;
  return { fontSize: "".concat(theme.typography.size.s2, "px") };
});
var H6 = styled.h6(withReset, headerCommon, function(_ref17) {
  var theme = _ref17.theme;
  return { fontSize: "".concat(theme.typography.size.s2, "px"), color: theme.color.dark };
});
var HR = styled.hr(function(_ref18) {
...
var LI = styled.li(withReset, function(_ref19) {
...
var Span = styled.span(withReset, function(_ref22) {
...
var Table$1 = styled.table(withReset, withMargin, function(_ref23) {
...
var BadgeWrapper = styled.div(function(_ref24) {
...
}, { svg: { height: 12, width: 12, marginRight: 4, marginTop: -2, path: { fill: "currentColor" } } }, function(_ref25) {
  var theme = _ref25.theme, status = _ref25.status;
  switch (status) {
    case "critical": {
...
var Symbols = (0, import_react.memo)(function(_ref27) {
  var _ref27$icons = _ref27.icons, keys3 = _ref27$icons === void 0 ? Object.keys(icons) : _ref27$icons;
  return import_react.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", style: { position: "absolute", width: 0, height: 0 }, "data-chromatic": "ignore" }, keys3.map(function(key) {
...
var LinkInner = styled.span(function(_ref28) {
  var withArrow = _ref28.withArrow;
...
var A$1 = styled.a(function(_ref30) {
  ...
  var theme = _ref31.theme, secondary = _ref31.secondary, tertiary = _ref31.tertiary;
  var colors;
  if (secondary) {
...
var DocumentWrapper = styled.div(function(_ref35) {
...
var Container$1 = styled.div(function(_ref36) {
...
var ActionButton = styled.button(function(_ref37) {
...
var ActionBar = function ActionBar2(_a) {
  ...
  return import_react.default.createElement(Container$1, Object.assign({}, props), actionItems.map(function(_ref39, index3) {
    var title = _ref39.title, className = _ref39.className, onClick = _ref39.onClick, disabled = _ref39.disabled;
    return import_react.default.createElement(ActionButton, { key: index3, className, onClick, disabled }, title);
  }));
};
var toNumber = function toNumber2(input) {
  return typeof input === "number" ? input : Number(input);
};
var Container = styled.div(function(_ref40) {
  var theme = _ref40.theme, col = _ref40.col, _ref40$row = _ref40.row, row = _ref40$row === void 0 ? 1 : _ref40$row;
  return col ? _defineProperty2({ display: "inline-block", verticalAlign: "inherit", "& > *": { marginLeft: col * theme.layoutMargin, verticalAlign: "inherit" } }, "& > *:first-child".concat(ignoreSsrWarning), { marginLeft: 0 }) : _defineProperty2({ "& > *": { marginTop: row * theme.layoutMargin } }, "& > *:first-child".concat(ignoreSsrWarning), { marginTop: 0 });
}, function(_ref43) {
  var theme = _ref43.theme, outer = _ref43.outer, col = _ref43.col, row = _ref43.row;
  switch (true) {
    case !!(outer && col): {
...
var GlobalScrollAreaStyles = (0, import_react.lazy)(function() {
  return import("./GlobalScrollAreaStyles-8793ce4a-5R7TYPYF.js");
});
var OverlayScrollbars = (0, import_react.lazy)(function() {
  return import("./OverlayScrollbars-51ef9016-OWCNY2UR.js");
});
...
var ScrollArea = styled(Scroller)(function(_ref46) {
  var vertical = _ref46.vertical;
  return !vertical ? { overflowY: "hidden" } : { overflowY: "auto", height: "100%" };
}, function(_ref47) {
  var horizontal = _ref47.horizontal;
...
function getAugmentedNamespace(n2) {
  ...
  Object.keys(n2).forEach(function(k2) {
    ...
    Object.defineProperty(a3, k2, d2.get ? d2 : { enumerable: true, get: function get2() {
      return n2[k2];
    } });
  });
  return a3;
...
var ZoomElementWrapper = styled.div(function(_ref48) {
  var _ref48$scale = _ref48.scale, scale = _ref48$scale === void 0 ? 1 : _ref48$scale, height = _ref48.height;
  return browserSupportsCssZoom() ? { "> *": { zoom: 1 / scale } } : { height: height + 50, transformOrigin: "top left", transform: "scale(".concat(1 / scale, ")") };
});
function ZoomElement(_ref49) {
  var scale = _ref49.scale, children = _ref49.children;
...
var ButtonWrapper = styled.button(function(_ref50) {
  var small2 = _ref50.small, theme = _ref50.theme;
  ...
  var containsIcon = _ref52.containsIcon, small2 = _ref52.small;
  return containsIcon ? Object.assign({ svg: { display: "block", margin: 0 } }, small2 ? { padding: 9 } : { padding: 12 }) : {};
}, function(_ref53) {
  var theme = _ref53.theme, primary = _ref53.primary, secondary = _ref53.secondary, gray = _ref53.gray;
  var color;
  if (gray) {
  ...
  var theme = _ref54.theme, tertiary = _ref54.tertiary, inForm = _ref54.inForm, small2 = _ref54.small;
  ...
  var theme = _ref55.theme, outline = _ref55.outline;
  ...
  var theme = _ref56.theme, outline = _ref56.outline, primary = _ref56.primary;
  ...
  var theme = _ref57.theme, outline = _ref57.outline, primary = _ref57.primary, secondary = _ref57.secondary;
  var color;
  if (secondary) {
    color = theme.color.secondary;
  } else if (primary) {
...
var Wrapper$7 = styled.label(function(_ref58) {
...
var Label$4 = styled.span(function(_ref59) {
...
var index2 = (0, import_react.forwardRef)(TextareaAutosize);
var TextareaAutoResize = index2;
var styleResets$1 = {
  appearance: "none",
  border: "0 none",
  boxSizing: "inherit",
...
var styles = function styles2(_ref60) {
...
var sizes = function sizes2(_ref61) {
  var size = _ref61.size;
  switch (size) {
    case "100%": {
      return { width: "100%" };
    }
...
var alignment = function alignment2(_ref62) {
  var align = _ref62.align;
  switch (align) {
    case "end": {
...
var validation = function validation2(_ref63) {
  var valid = _ref63.valid, theme = _ref63.theme;
  switch (valid) {
    case "valid": {
...
}))(styles, sizes, alignment, validation, function(_ref64) {
  var _ref64$height = _ref64.height, height = _ref64$height === void 0 ? 400 : _ref64$height;
...
var LazyWithTooltip = (0, import_react.lazy)(function() {
  return import("./WithTooltip-de70e3a7-L2TH3GKH.js").then(function(mod) {
...
var TooltipMessage = function TooltipMessage2(_ref68) {
  var title = _ref68.title, desc = _ref68.desc, links = _ref68.links;
...
var Note = styled.div(function(_ref69) {
  ...
  (function(f2) {
    ...
    return function e2(t, n2, r2) {
      function s2(o3, u2) {
        if (!n2[o3]) {
          if (!t[o3]) {
            var a3 = typeof commonjsRequire == "function" && commonjsRequire;
            if (!u2 && a3)
              return a3(o3, true);
            if (i2)
              return i2(o3, true);
        ...
        return function(fn) {
          var memoizerific2 = function memoizerific3() {
            ...
            for (i2 = 0; i2 < argsLengthMinusOne; i2++) {
              lruPath[i2] = { cacheItem: currentCache, arg: arguments[i2] };
...
var Title$1 = styled(function(_a) {
  ...
  var active = _ref71.active, theme = _ref71.theme;
  return active ? { color: theme.color.primary, fontWeight: theme.typography.weight.bold } : {};
}, function(_ref72) {
  var loading = _ref72.loading, theme = _ref72.theme;
  return loading ? Object.assign({ display: "inline-block", flex: "none" }, theme.animation.inlineGlow) : {};
}, function(_ref73) {
  var disabled = _ref73.disabled, theme = _ref73.theme;
  return disabled ? { color: curriedTransparentize$1(0.7, theme.color.defaultText) } : {};
});
var Right = styled.span({ "& svg": { transition: "all 200ms ease-out", opacity: 0, height: 12, width: 12, margin: "3px 0", verticalAlign: "top" }, "& path": { fill: "inherit" } }, function(_ref74) {
  var active = _ref74.active, theme = _ref74.theme;
...
var CenterText = styled.span({ flex: 1, textAlign: "center" }, function(_ref75) {
  var active = _ref75.active, theme = _ref75.theme;
  return active ? { color: theme.color.primary } : {};
}, function(_ref76) {
  var theme = _ref76.theme, disabled = _ref76.disabled;
  return disabled ? { color: theme.color.mediumdark } : {};
});
var Left = styled.span(function(_ref77) {
  var active = _ref77.active, theme = _ref77.theme;
  return active ? { "& svg": { opacity: 1 }, "& path": { fill: theme.color.primary } } : {};
});
var Item$3 = styled.a(function(_ref78) {
...
var List$2 = styled.div({ minWidth: 180, overflow: "hidden", overflowY: "auto", maxHeight: 13.5 * 32 }, function(_ref80) {
...
var TooltipLinkList = function TooltipLinkList2(_ref81) {
  var links = _ref81.links, LinkWrapper = _ref81.LinkWrapper;
...
var Side = styled.div({ display: "flex", whiteSpace: "nowrap", flexBasis: "auto", flexShrink: 0, marginLeft: 3, marginRight: 3 }, function(_ref82) {
  var left2 = _ref82.left;
  return left2 ? { "& > *": { marginLeft: 4 } } : {};
}, function(_ref83) {
  var right2 = _ref83.right;
  return right2 ? { marginLeft: 30, "& > *": { marginRight: 4 } } : {};
});
Side.displayName = "Side";
var Bar$1 = styled(function(_ref84) {
  var children = _ref84.children, className = _ref84.className;
...
var TabButton = styled(ButtonOrLink, { shouldForwardProp: index })({ whiteSpace: "normal", display: "inline-flex", overflow: "hidden", verticalAlign: "top", justifyContent: "center", alignItems: "center", textAlign: "center", textDecoration: "none", "&:empty": { display: "none" } }, function(_ref88) {
  ...
  var active = _ref89.active, textColor = _ref89.textColor, theme = _ref89.theme;
...
var IconButton = styled(ButtonOrLink, { shouldForwardProp: index })(function() {
  ...
  var active = _ref90.active, theme = _ref90.theme;
  return active ? { backgroundColor: theme.background.hoverable, color: theme.color.secondary } : {};
}, function(_ref91) {
  var disabled = _ref91.disabled, theme = _ref91.theme;
...
var IconPlaceholder = styled.div(function(_ref92) {
...
var Wrapper$6 = styled.div(function(_ref93) {
  var theme = _ref93.theme, bordered = _ref93.bordered;
...
var Content = styled.div({ display: "block", position: "relative" }, function(_ref95) {
  var theme = _ref95.theme;
  return { fontSize: theme.typography.size.s2 - 1, background: theme.background.content };
}, function(_ref96) {
  var bordered = _ref96.bordered, theme = _ref96.theme;
  return bordered ? { borderRadius: "0 0 ".concat(theme.appBorderRadius - 1, "px ").concat(theme.appBorderRadius - 1, "px") } : {};
}, function(_ref97) {
  var absolute = _ref97.absolute, bordered = _ref97.bordered;
  return absolute ? _defineProperty2({ height: "calc(100% - ".concat(bordered ? 42 : 40, "px)"), position: "absolute", left: 0 + (bordered ? 1 : 0), right: 0 + (bordered ? 1 : 0), bottom: 0 + (bordered ? 1 : 0), top: 40 + (bordered ? 1 : 0), overflow: "auto" }, "& > *:first-child".concat(ignoreSsrWarning2), { position: "absolute", left: 0 + (bordered ? 1 : 0), right: 0 + (bordered ? 1 : 0), bottom: 0 + (bordered ? 1 : 0), top: 0 + (bordered ? 1 : 0), height: "calc(100% - ".concat(bordered ? 2 : 0, "px)"), overflow: "auto" }) : {};
});
var VisuallyHidden = styled.div(function(_ref99) {
  var active = _ref99.active;
  return active ? { display: "block" } : { display: "none" };
});
var TabWrapper = function TabWrapper2(_ref100) {
  var active = _ref100.active, render = _ref100.render, children = _ref100.children;
...
var childrenToList = function childrenToList2(children, selected) {
  return import_react.Children.toArray(children).map(function(_ref101, index3) {
    var _ref101$props = _ref101.props, title = _ref101$props.title, id = _ref101$props.id, color = _ref101$props.color, childrenOfChild = _ref101$props.children;
    var content = Array.isArray(childrenOfChild) ? childrenOfChild[0] : childrenOfChild;
    return { active: selected ? id === selected : index3 === 0, title, id, color, render: typeof content === "function" ? content : function(_ref102) {
      var active = _ref102.active, key = _ref102.key;
      return import_react.default.createElement(VisuallyHidden, { key, active, role: "tabpanel" }, content);
    } };
  });
};
var Tabs = (0, import_react.memo)(function(_ref103) {
  var children = _ref103.children, selected = _ref103.selected, actions = _ref103.actions, absolute = _ref103.absolute, bordered = _ref103.bordered, tools = _ref103.tools, backgroundColor = _ref103.backgroundColor, htmlId = _ref103.id;
  var list = childrenToList(children, selected);
  return list.length ? import_react.default.createElement(Wrapper$6, { absolute, bordered, id: htmlId }, import_react.default.createElement(FlexBar, { border: true, backgroundColor }, import_react.default.createElement(TabBar, { role: "tablist" }, list.map(function(_ref104) {
    var title = _ref104.title, id = _ref104.id, active = _ref104.active, color = _ref104.color;
  ...
  })), tools ? import_react.default.createElement(import_react.Fragment, null, tools) : null), import_react.default.createElement(Content, { id: "panel-tab-content", bordered, absolute }, list.map(function(_ref105) {
    var id = _ref105.id, active = _ref105.active, render = _ref105.render;
...
var Separator = styled.span(function(_ref106) {
  var theme = _ref106.theme;
  return { width: 1, height: 20, background: theme.appBorderColor, marginTop: 10, marginLeft: 6, marginRight: 2 };
}, function(_ref107) {
  var force = _ref107.force;
  return force ? {} : { "& + &": { display: "none" } };
});
Separator.displayName = "Separator";
var interleaveSeparators = function interleaveSeparators2(list) {
  return list.reduce(function(acc, item, index3) {
    return item ? import_react.default.createElement(import_react.Fragment, { key: item.id || item.key || "f-".concat(index3) }, acc, index3 > 0 ? import_react.default.createElement(Separator, { key: "s-".concat(index3) }) : null, item.render() || item) : acc;
  }, null);
};
...
var AddonPanel = function AddonPanel2(_ref108) {
  var active = _ref108.active, children = _ref108.children;
...
function Bt(r2) {
  ...
  } }, headingSetext: { i: kt($7), l: Ot.MAX, _: function _(t, e2, n2) {
...
var Description$1 = function Description$12(_ref109) {
  var markdown = _ref109.markdown;
...
var breakpoint = 600;
var Title = styled.h1(withReset, function(_ref110) {
...
var DocsPageWrapper = function DocsPageWrapper2(_ref116) {
...
var stringToPath$2 = function stringToPath(string2) {
  ...
  var result2 = [];
  $replace$1(string2, rePropName$1, function(match, number, quote2, subString) {
    result2[result2.length] = quote2 ? $replace$1(subString, reEscapeChar$1, "$1") : number || match;
  });
  return result2;
};
...
var $indexOf2 = callBind(GetIntrinsic$1("String.prototype.indexOf"));
...
var objectInspect = function inspect_(obj, options, depth, seen) {
  ...
  if (depth >= maxDepth && maxDepth > 0 && _typeof(obj) === "object") {
    return isArray$d(obj) ? "[Array]" : "[Object]";
  }
  ...
  if (typeof obj === "function") {
    ...
    return "[Function" + (name ? ": " + name : " (anonymous)") + "]" + (keys3.length > 0 ? " { " + $join2.call(keys3, ", ") + " }" : "");
  }
  if (isSymbol$4(obj)) {
  ...
  if (isArray$d(obj)) {
    ...
    return "[ " + $join2.call(xs, ", ") + " ]";
  }
  if (isError(obj)) {
    var parts = arrObjKeys(obj, inspect2);
    if ("cause" in obj && !isEnumerable.call(obj, "cause")) {
      return "{ [" + String(obj) + "] " + $join2.call($concat.call("[cause]: " + inspect2(obj.cause), parts), ", ") + " }";
    }
    if (parts.length === 0) {
      return "[" + String(obj) + "]";
    }
    return "{ [" + String(obj) + "] " + $join2.call(parts, ", ") + " }";
  }
  ...
  if (!isDate(obj) && !isRegExp$1(obj)) {
    ...
    var tag = constructorTag + (stringTag2 || protoTag ? "[" + $join2.call($concat.call([], stringTag2 || [], protoTag || []), ": ") + "] " : "");
    if (ys.length === 0) {
      return tag + "{}";
    }
    if (indent) {
...
function isMap$2(x2) {
  if (!mapSize || !x2 || _typeof(x2) !== "object") {
    return false;
  }
  try {
    mapSize.call(x2);
...
function isWeakMap(x2) {
  if (!weakMapHas || !x2 || _typeof(x2) !== "object") {
    return false;
  }
  try {
...
function isWeakRef(x2) {
  if (!weakRefDeref || !x2 || _typeof(x2) !== "object") {
    return false;
  }
  try {
...
function isSet$2(x2) {
  if (!setSize || !x2 || _typeof(x2) !== "object") {
    return false;
  }
  try {
    setSize.call(x2);
...
function isWeakSet(x2) {
  if (!weakSetHas || !x2 || _typeof(x2) !== "object") {
    return false;
  }
  try {
    weakSetHas.call(x2, weakSetHas);
...
function lowbyte(c2) {
  ...
  var x2 = { 8: "b", 9: "t", 10: "n", 12: "f", 13: "r" }[n2];
  if (x2) {
    return "\\" + x2;
  }
...
function collectionOf(type, size, entries2, indent) {
  var joinedEntries = indent ? indentedJoin(entries2, indent) : $join2.call(entries2, ", ");
...
function getIndent(opts, depth) {
  ...
  if (opts.indent === "	") {
    ...
    baseIndent = $join2.call(Array(opts.indent + 1), " ");
  } else {
    return null;
  }
  return { base: baseIndent, prev: $join2.call(Array(depth + 1), baseIndent) };
}
function indentedJoin(xs, indent) {
  ...
  return lineJoiner + $join2.call(xs, "," + lineJoiner) + "\n" + indent.prev;
}
function arrObjKeys(obj, inspect2) {
  var isArr = isArray$d(obj);
  var xs = [];
  if (isArr) {
...
var listSet = function listSet2(objects, key, value2) {
  var node = listGetNode(objects, key);
  if (node) {
    node.value = value2;
  } else {
...
var sideChannel = function getSideChannel() {
  ...
  var $m;
  var $o;
  var channel = { assert: function assert(key) {
    if (!channel.has(key)) {
...
var Format = { RFC1738: "RFC1738", RFC3986: "RFC3986" };
var formats$3 = { "default": Format.RFC3986, formatters: { RFC1738: function RFC1738(value2) {
  return replace.call(value2, percentTwenties, "+");
}, RFC3986: function RFC3986(value2) {
...
var merge = function merge2(target, source, options) {
  ...
  if (isArray$c(target) && !isArray$c(source)) {
...
var utils$2 = { arrayToObject, assign, combine, compact, decode, encode, isBuffer: isBuffer$4, isRegExp, maybeMap, merge };
var getSideChannel2 = sideChannel;
var utils$1 = utils$2;
var formats$1 = formats$3;
var has$1 = Object.prototype.hasOwnProperty;
var arrayPrefixGenerators = { brackets: function brackets(prefix) {
  return prefix + "[]";
}, comma: "comma", indices: function indices(prefix, key) {
  return prefix + "[" + key + "]";
...
var pushToArray = function pushToArray2(arr, valueOrArray) {
  push.apply(arr, isArray$b(valueOrArray) ? valueOrArray : [valueOrArray]);
};
...
var isNonNullishPrimitive = function isNonNullishPrimitive2(v2) {
  return typeof v2 === "string" || typeof v2 === "number" || typeof v2 === "boolean" || _typeof(v2) === "symbol" || typeof v2 === "bigint";
};
var sentinel = {};
var stringify$1 = function stringify(object2, prefix, generateArrayPrefix, strictNullHandling, skipNulls, encoder, filter2, sort2, allowDots, serializeDate2, format3, formatter, encodeValuesOnly, charset, sideChannel2) {
  var obj = object2;
  ...
  } else if (generateArrayPrefix === "comma" && isArray$b(obj)) {
    ...
    if (encoder) {
      ...
      if (generateArrayPrefix === "comma" && encodeValuesOnly) {
        ...
        for (var i2 = 0; i2 < valuesArray.length; ++i2) {
          valuesJoined += (i2 === 0 ? "" : ",") + formatter(encoder(valuesArray[i2], defaults$1.encoder, charset, "value", format3));
        }
  ...
  var objKeys;
  if (generateArrayPrefix === "comma" && isArray$b(obj)) {
    objKeys = [{ value: obj.length > 0 ? obj.join(",") || null : void 0 }];
  } else if (isArray$b(filter2)) {
    objKeys = filter2;
  } else {
    var keys3 = Object.keys(obj);
  ...
  for (var j2 = 0; j2 < objKeys.length; ++j2) {
    var key = objKeys[j2];
    var value2 = _typeof(key) === "object" && typeof key.value !== "undefined" ? key.value : obj[key];
    if (skipNulls && value2 === null) {
      continue;
    }
    var keyPrefix = isArray$b(obj) ? typeof generateArrayPrefix === "function" ? generateArrayPrefix(prefix, key) : prefix : prefix + (allowDots ? "." + key : "[" + key + "]");
    sideChannel2.set(object2, step);
    var valueSideChannel = getSideChannel2();
    valueSideChannel.set(sentinel, sideChannel2);
    pushToArray(values2, stringify(value2, keyPrefix, generateArrayPrefix, strictNullHandling, skipNulls, encoder, filter2, sort2, allowDots, serializeDate2, format3, formatter, encodeValuesOnly, charset, valueSideChannel));
  }
  return values2;
};
...
var stringify_1 = function stringify_12(object2, opts) {
  ...
  if (typeof options.filter === "function") {
    ...
    obj = filter2("", obj);
  } else if (isArray$b(options.filter)) {
    filter2 = options.filter;
    objKeys = filter2;
  }
  var keys3 = [];
...
var parse$4 = function parse$42(str, opts) {
...
var lib = { formats, parse: parse$3, stringify: stringify2 };
...
var Zoom = function Zoom2(_ref117) {
  var zoom = _ref117.zoom, resetZoom = _ref117.resetZoom;
...
var Eject = function Eject2(_ref118) {
  var baseUrl = _ref118.baseUrl, storyId = _ref118.storyId;
...
var IFrame = function(_Component3) {
  ...
  _createClass(IFrame2, [{ key: "componentDidMount", value: function componentDidMount() {
    ...
    var _a = this.props, id = _a.id, title = _a.title, src2 = _a.src, allowFullScreen = _a.allowFullScreen, scale = _a.scale, rest = __rest(_a, ["id", "title", "src", "allowFullScreen", "scale"]);
...
var LoaderWrapper = styled.div(function(_ref119) {
  var _ref119$size = _ref119.size, size = _ref119$size === void 0 ? 32 : _ref119$size;
...
var ProgressTrack = styled.div(function(_ref120) {
...
var InlineStory = function InlineStory2(_ref124) {
  var storyFn = _ref124.storyFn, height = _ref124.height, id = _ref124.id;
...
var IFrameStory = function IFrameStory2(_ref125) {
  var id = _ref125.id, title = _ref125.title, _ref125$height = _ref125.height, height = _ref125$height === void 0 ? "500px" : _ref125$height;
  return import_react.default.createElement("div", { style: { width: "100%", height } }, import_react.default.createElement(ZoomContext.Consumer, null, function(_ref126) {
    var scale = _ref126.scale;
...
var ChildrenContainer = styled.div(function(_ref127) {
  var isColumn = _ref127.isColumn, columns = _ref127.columns, layout = _ref127.layout;
  ...
  var _ref128$layout = _ref128.layout, layout = _ref128$layout === void 0 ? "padded" : _ref128$layout;
...
var PreviewContainer = styled.div(function(_ref132) {
  var theme = _ref132.theme, withSource = _ref132.withSource, isExpanded = _ref132.isExpanded;
  ...
  var withToolbar = _ref133.withToolbar;
...
function arrayMap$2(array2, iteratee) {
  ...
  while (++index3 < length) {
    result2[index3] = iteratee(array2[index3], index3, array2);
  }
  return result2;
}
...
function listCacheDelete$1(key) {
  var data = this.__data__, index3 = assocIndexOf$3(data, key);
  if (index3 < 0) {
    return false;
  }
...
function listCacheGet$1(key) {
  var data = this.__data__, index3 = assocIndexOf$2(data, key);
...
function ListCache$4(entries2) {
  var index3 = -1, length = entries2 == null ? 0 : entries2.length;
  this.clear();
  while (++index3 < length) {
...
function equalArrays$2(array2, other, bitmask, customizer, equalFunc, stack) {
  ...
  var index3 = -1, result2 = true, seen = bitmask & COMPARE_UNORDERED_FLAG$3 ? new SetCache$1() : void 0;
...
function arrayPush$2(array2, values2) {
  var index3 = -1, length = values2.length, offset = array2.length;
  while (++index3 < length) {
    array2[offset + index3] = values2[index3];
  }
  return array2;
}
...
var stringToPath$1 = memoizeCapped(function(string2) {
  ...
  string2.replace(rePropName, function(match, number, quote2, subString) {
...
function castPath$4(value2, object2) {
  ...
  return isKey$2(value2, object2) ? [value2] : stringToPath2(toString(value2));
}
...
function baseGet$3(object2, path) {
  ...
  while (object2 != null && index3 < length) {
    object2 = object2[toKey$4(path[index3++])];
  }
...
var pickBy_1 = pickBy;
var Table = styled.table(function(_ref134) {
...
var ArgJsDoc = function ArgJsDoc2(_ref135) {
  var tags = _ref135.tags;
...
var INFINITY = 1 / 0;
var createSet$1 = !(Set$1 && 1 / setToArray$1(new Set$1([, -0]))[1] == INFINITY) ? noop2 : function(values2) {
...
function baseUniq$1(array2, iteratee, comparator) {
  var index3 = -1, includes2 = arrayIncludes, length = array2.length, isCommon = true, result2 = [], seen = result2;
  if (comparator) {
    isCommon = false;
...
var Summary = styled.div(function(_ref136) {
  var isExpanded = _ref136.isExpanded;
...
var Text$2 = styled.span(codeCommon, function(_ref137) {
  var theme = _ref137.theme, _ref137$simple = _ref137.simple, simple = _ref137$simple === void 0 ? false : _ref137$simple;
...
var ExpandButton = styled.button(function(_ref138) {
...
var Expandable = styled.div(codeCommon, function(_ref139) {
...
var Detail = styled.div(function(_ref140) {
  var theme = _ref140.theme, width = _ref140.width;
  return {
    width,
    minWidth: 200,
    maxWidth: 800,
...
var ArgText = function ArgText2(_ref141) {
  var text = _ref141.text, simple = _ref141.simple;
...
var ArgSummary = function ArgSummary2(_ref142) {
  var value2 = _ref142.value, initialExpandedArgs = _ref142.initialExpandedArgs;
...
var ArgValue = function ArgValue2(_ref143) {
...
var Label$3 = styled.label(function(_ref144) {
...
var BooleanControl = function BooleanControl2(_ref145) {
  var name = _ref145.name, value2 = _ref145.value, _onChange = _ref145.onChange, onBlur = _ref145.onBlur, onFocus = _ref145.onFocus;
...
var FlexSpaced = styled.div(function(_ref146) {
  var theme = _ref146.theme;
  return { flex: 1, display: "flex", input: { marginLeft: 10, flex: 1, height: 32, "&::-webkit-calendar-picker-indicator": { opacity: 0.5, height: 12, filter: theme.base === "light" ? void 0 : "invert(1)" } }, "input:first-of-type": { marginLeft: 0 } };
});
var DateControl = function DateControl2(_ref147) {
  var name = _ref147.name, value2 = _ref147.value, onChange = _ref147.onChange, onFocus = _ref147.onFocus, onBlur = _ref147.onBlur;
...
var NumberControl = function NumberControl2(_ref148) {
  var name = _ref148.name, value2 = _ref148.value, onChange = _ref148.onChange, min = _ref148.min, max = _ref148.max, step = _ref148.step, onBlur = _ref148.onBlur, onFocus = _ref148.onFocus;
...
var selectedKey = function selectedKey2(value2, options) {
  var entry = options && Object.entries(options).find(function(_ref149) {
    var _ref150 = _slicedToArray(_ref149, 2), _key = _ref150[0], val = _ref150[1];
    return val === value2;
  });
...
var selectedValues = function selectedValues2(keys3, options) {
  return keys3 && options && keys3.map(function(key) {
    return options[key];
  });
};
var Wrapper$4 = styled.div(function(_ref151) {
  var isInline = _ref151.isInline;
...
var CheckboxControl = function CheckboxControl2(_ref152) {
  var name = _ref152.name, options = _ref152.options, value2 = _ref152.value, onChange = _ref152.onChange, isInline = _ref152.isInline;
  if (!options) {
  ...
  var controlId = getControlId(name);
  return import_react.default.createElement(Wrapper$4, { isInline }, Object.keys(options).map(function(key, index3) {
    var id = "".concat(controlId, "-").concat(index3);
...
var Wrapper$3 = styled.div(function(_ref153) {
  var isInline = _ref153.isInline;
  return isInline ? { display: "flex", flexWrap: "wrap", alignItems: "flex-start", label: { display: "inline-flex", marginRight: 15 } } : { label: { display: "flex" } };
});
...
var RadioControl = function RadioControl2(_ref154) {
  var name = _ref154.name, options = _ref154.options, value2 = _ref154.value, _onChange2 = _ref154.onChange, isInline = _ref154.isInline;
  if (!options) {
  ...
  var controlId = getControlId(name);
  return import_react.default.createElement(Wrapper$3, { isInline }, Object.keys(options).map(function(key, index3) {
    var id = "".concat(controlId, "-").concat(index3);
...
var OptionsSelect = styled.select(function(_ref155) {
...
var SingleSelect = function SingleSelect2(_ref156) {
  var name = _ref156.name, value2 = _ref156.value, options = _ref156.options, onChange = _ref156.onChange;
  var handleChange = function handleChange2(e2) {
...
var MultiSelect = function MultiSelect2(_ref157) {
...
var isBuffer2 = isBuffer$3.exports;
var isMap = isMap_1;
...
var JsonArray = function(_Component5) {
  ...
  _createClass(JsonArray2, [{ key: "onChildUpdate", value: function onChildUpdate(childKey, childData) {
  ...
  } }, { key: "handleRemoveItem", value: function handleRemoveItem(index3) {
    var _this7 = this;
    return function() {
      ...
      var oldValue = data[index3];
      beforeRemoveAction2(index3, keyPath, deep, oldValue).then(function() {
        var deltaUpdateResult = { keyPath, deep, key: index3, oldValue, type: REMOVE_DELTA_TYPE };
  ...
  } }, { key: "handleAddValueAdd", value: function handleAddValueAdd(_ref158) {
    var _this8 = this;
    var newValue = _ref158.newValue;
  ...
  } }, { key: "handleEditValue", value: function handleEditValue(_ref159) {
    var _this9 = this;
    var key = _ref159.key, value2 = _ref159.value;
    ...
    var startObject = "[";
    var endObject = "]";
    return import_react.default.createElement("span", { className: "rejt-not-collapsed" }, import_react.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !addFormVisible && addItemButton, import_react.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul2 }, data.map(function(item, index3) {
      return import_react.default.createElement(JsonNode, { key: index3, name: "".concat(index3), data: item, keyPath, deep: nextDeep, isCollapsed: isCollapsed2, handleRemove: _this10.handleRemoveItem(index3), handleUpdateValue: _this10.handleEditValue, onUpdate: _this10.onChildUpdate, onDeltaUpdate: onDeltaUpdate2, readOnly: readOnly2, getStyle: getStyle2, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction: beforeRemoveAction2, beforeAddAction: beforeAddAction2, beforeUpdateAction: beforeUpdateAction2, logger: logger2, onSubmitValueParser: onSubmitValueParser2 });
...
var JsonObject = function(_Component8) {
  ...
  _createClass(JsonObject2, [{ key: "onChildUpdate", value: function onChildUpdate(childKey, childData) {
    ...
    this.setState({ addFormVisible: false });
  } }, { key: "handleAddValueAdd", value: function handleAddValueAdd(_ref160) {
    var _this15 = this;
    var key = _ref160.key, newValue = _ref160.newValue;
  ...
  } }, { key: "handleEditValue", value: function handleEditValue(_ref161) {
    var _this17 = this;
    var key = _ref161.key, value2 = _ref161.value;
    return new Promise(function(resolve, reject) {
...
var Wrapper$2 = styled.div(function(_ref162) {
...
var Button = styled.button(function(_ref163) {
  var theme = _ref163.theme, primary = _ref163.primary;
...
var ActionIcon = styled(Icons)(function(_ref164) {
  var theme = _ref164.theme, icon = _ref164.icon, disabled = _ref164.disabled;
...
var Input = styled.input(function(_ref165) {
  var theme = _ref165.theme, placeholder = _ref165.placeholder;
...
var RawButton = styled(IconButton)(function(_ref166) {
...
var RawInput = styled(Form.Textarea)(function(_ref167) {
...
var ObjectControl = function ObjectControl2(_ref168) {
  var name = _ref168.name, value2 = _ref168.value, onChange = _ref168.onChange;
  var theme = useTheme();
...
var RangeControl = function RangeControl2(_ref170) {
  var name = _ref170.name, value2 = _ref170.value, onChange = _ref170.onChange, _ref170$min = _ref170.min, min = _ref170$min === void 0 ? 0 : _ref170$min, _ref170$max = _ref170.max, max = _ref170$max === void 0 ? 100 : _ref170$max, _ref170$step = _ref170.step, step = _ref170$step === void 0 ? 1 : _ref170$step, onBlur = _ref170.onBlur, onFocus = _ref170.onFocus;
  var handleChange = function handleChange2(event) {
  ...
  return import_react.default.createElement(RangeWrapper, null, import_react.default.createElement(RangeLabel, null, min), import_react.default.createElement(RangeInput, Object.assign({ id: getControlId(name), type: "range", onChange: handleChange }, { name, value: value2, min, max, step, onFocus, onBlur })), import_react.default.createElement(RangeLabel, null, "".concat(hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--"), " / ", max));
};
var Wrapper$1 = styled.label({ display: "flex" });
var TextControl = function TextControl2(_ref171) {
  var name = _ref171.name, value2 = _ref171.value, onChange = _ref171.onChange, onFocus = _ref171.onFocus, onBlur = _ref171.onBlur;
  var handleChange = function handleChange2(event) {
...
var FilesControl = function FilesControl2(_ref172) {
  var onChange = _ref172.onChange, name = _ref172.name, _ref172$accept = _ref172.accept, accept = _ref172$accept === void 0 ? "image/*" : _ref172$accept, value2 = _ref172.value;
...
var LazyColorControl = (0, import_react.lazy)(function() {
  return import("./Color-f506f22b-KHX7CB7Y.js");
});
...
var ArgControl = function ArgControl2(_ref173) {
  var row = _ref173.row, arg = _ref173.arg, updateArgs = _ref173.updateArgs;
...
var Type = styled.div(function(_ref176) {
  var theme = _ref176.theme, hasDescription = _ref176.hasDescription;
...
var TypeWithJsDoc = styled.div(function(_ref177) {
...
var StyledTd$1 = styled.td(function(_ref178) {
  var theme = _ref178.theme, expandable = _ref178.expandable;
  return { paddingLeft: expandable ? "40px !important" : "20px !important" };
});
var ArgRow = function ArgRow2(props) {
  var _a;
  var row = props.row, updateArgs = props.updateArgs, compact3 = props.compact, expandable = props.expandable, initialExpandedArgs = props.initialExpandedArgs;
  ...
  return import_react.default.createElement("tr", null, import_react.default.createElement(StyledTd$1, { expandable }, import_react.default.createElement(Name, null, name), required ? import_react.default.createElement(Required, { title: "Required" }, "*") : null), compact3 ? null : import_react.default.createElement("td", null, hasDescription && import_react.default.createElement(Description, null, import_react.default.createElement(Markdown, null, description)), table2.jsDocTags != null ? import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(TypeWithJsDoc, { hasDescription }, import_react.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react.default.createElement(ArgJsDoc, { tags: table2.jsDocTags })) : import_react.default.createElement(Type, { hasDescription }, import_react.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact3 ? null : import_react.default.createElement("td", null, import_react.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react.default.createElement("td", null, import_react.default.createElement(ArgControl, Object.assign({}, props))) : null);
};
var ExpanderIcon = styled(Icons)(function(_ref179) {
...
var FlexWrapper = styled.span(function(_ref180) {
  var theme = _ref180.theme;
  return { display: "flex", lineHeight: "20px", alignItems: "center" };
});
var Section = styled.td(function(_ref181) {
...
var Subsection = styled.td(function(_ref182) {
...
var StyledTd = styled.td(function(_ref183) {
  var theme = _ref183.theme;
  return { position: "relative" };
});
var StyledTr = styled.tr(function(_ref184) {
...
var SectionRow = function SectionRow2(_ref185) {
  var _ref185$level = _ref185.level, level = _ref185$level === void 0 ? "section" : _ref185$level, label = _ref185.label, children = _ref185.children, _ref185$initialExpand = _ref185.initialExpanded, initialExpanded = _ref185$initialExpand === void 0 ? true : _ref185$initialExpand, _ref185$colSpan = _ref185.colSpan, colSpan = _ref185$colSpan === void 0 ? 3 : _ref185$colSpan;
...
var TableWrapper = styled.table(function(_ref186) {
  var _trFirstChild$conca, _trLastChild$concat, _3;
  var theme = _ref186.theme, compact3 = _ref186.compact, inAddonPanel = _ref186.inAddonPanel;
  return { "&&": (_3 = {
    borderCollapse: "collapse",
    borderSpacing: 0,
    color: theme.color.defaultText,
    ...
    "th:nth-of-type(2), td:nth-of-type(2)": Object.assign({}, compact3 ? null : {
      width: "35%"
    }),
    "td:nth-of-type(3)": Object.assign({}, compact3 ? null : {
      width: "15%"
    }),
    "th:last-of-type, td:last-of-type": Object.assign({ paddingRight: 20 }, compact3 ? null : {
      width: "25%"
    }),
  ...
  }, _defineProperty2(_3, "tr:first-child".concat(ignoreSsrWarning), (_trFirstChild$conca = {}, _defineProperty2(_trFirstChild$conca, "td:first-child".concat(ignoreSsrWarning, ", th:first-child").concat(ignoreSsrWarning), { borderTopLeftRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _defineProperty2(_trFirstChild$conca, "td:last-child".concat(ignoreSsrWarning, ", th:last-child").concat(ignoreSsrWarning), { borderTopRightRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _trFirstChild$conca)), _defineProperty2(_3, "tr:last-child".concat(ignoreSsrWarning), (_trLastChild$concat = {}, _defineProperty2(_trLastChild$concat, "td:first-child".concat(ignoreSsrWarning, ", th:first-child").concat(ignoreSsrWarning), { borderBottomLeftRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _defineProperty2(_trLastChild$concat, "td:last-child".concat(ignoreSsrWarning, ", th:last-child").concat(ignoreSsrWarning), { borderBottomRightRadius: inAddonPanel ? 0 : theme.appBorderRadius }), _trLastChild$concat)), _defineProperty2(_3, "tbody", {
  ...
  var isLoading = _ref188.isLoading, theme = _ref188.theme;
...
var ResetButton = styled.button(function(_ref189) {
...
var groupRows = function groupRows2(rows, sort2) {
  var sections = { ungrouped: [], ungroupedSubsections: {}, sections: {} };
  if (!rows)
    return sections;
  Object.entries(rows).forEach(function(_ref190) {
    var _ref191 = _slicedToArray(_ref190, 2), key = _ref191[0], row = _ref191[1];
    var _ref192 = (row === null || row === void 0 ? void 0 : row.table) || {}, category = _ref192.category, subcategory = _ref192.subcategory;
    if (category) {
...
var ArgsTable = function ArgsTable2(props) {
  ...
  var updateArgs = props.updateArgs, resetArgs = props.resetArgs, compact3 = props.compact, inAddonPanel = props.inAddonPanel, initialExpandedArgs = props.initialExpandedArgs, _props$sort = props.sort, sort2 = _props$sort === void 0 ? "none" : _props$sort;
  var isLoading = "isLoading" in props;
  var _ref193 = "rows" in props ? props : argsTableLoadingData, rows = _ref193.rows, args = _ref193.args;
  var groups = groupRows(pickBy_1(rows, function(row) {
    var _a;
    return !((_a = row === null || row === void 0 ? void 0 : row.table) === null || _a === void 0 ? void 0 : _a.disable) && (0, import_csf.includeConditionalArg)(row, args);
  }), sort2);
  ...
  var common = { updateArgs, compact: compact3, inAddonPanel, initialExpandedArgs };
  return import_react.default.createElement(ResetWrapper, null, import_react.default.createElement(TableWrapper, Object.assign({ "aria-hidden": isLoading }, { compact: compact3, inAddonPanel, isLoading }, { className: "docblock-argstable" }), import_react.default.createElement("thead", { className: "docblock-argstable-head" }, import_react.default.createElement("tr", null, import_react.default.createElement("th", null, import_react.default.createElement("span", null, "Name")), compact3 ? null : import_react.default.createElement("th", null, import_react.default.createElement("span", null, "Description")), compact3 ? null : import_react.default.createElement("th", null, import_react.default.createElement("span", null, "Default")), updateArgs ? import_react.default.createElement("th", null, import_react.default.createElement(ControlHeadingWrapper, null, "Control", " ", !isLoading && resetArgs && import_react.default.createElement(ResetButton, { onClick: function onClick() {
    return resetArgs();
  ...
  }), Object.entries(groups.ungroupedSubsections).map(function(_ref194) {
    var _ref195 = _slicedToArray(_ref194, 2), subcategory = _ref195[0], subsection = _ref195[1];
  ...
  }), Object.entries(groups.sections).map(function(_ref196) {
    var _ref197 = _slicedToArray(_ref196, 2), category = _ref197[0], section = _ref197[1];
    return import_react.default.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map(function(row) {
      return import_react.default.createElement(ArgRow, Object.assign({ key: row.key, row, arg: args && args[row.key] }, common));
    }), Object.entries(section.subsections).map(function(_ref198) {
      var _ref199 = _slicedToArray(_ref198, 2), subcategory = _ref199[0], subsection = _ref199[1];
      return import_react.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map(function(row) {
        return import_react.default.createElement(ArgRow, Object.assign({ key: row.key, row, arg: args && args[row.key], expandable }, common));
      }));
    }));
...
var TabbedArgsTable = function TabbedArgsTable2(_a) {
  ...
  var entries2 = Object.entries(tabs);
  if (entries2.length === 1) {
    return import_react.default.createElement(ArgsTable, Object.assign({}, entries2[0][1], props));
  }
  return import_react.default.createElement(TabsState, null, entries2.map(function(entry) {
    var _entry = _slicedToArray(entry, 2), label = _entry[0], table2 = _entry[1];
    var id = "prop_table_div_".concat(label);
    return import_react.default.createElement("div", { key: id, id, title: label }, function(_ref200) {
      var active = _ref200.active;
      return active ? import_react.default.createElement(ArgsTable, Object.assign({ key: "prop_table_".concat(label) }, table2, props)) : null;
    });
  }));
};
var NoControlsWrapper = styled.div(function(_ref201) {
...
var Label = styled.div(function(_ref202) {
...
var Wrapper = styled.div(withReset, function(_ref203) {
...
var SwatchLabel = styled.div(function(_ref206) {
...
var Swatch = styled.div(function(_ref207) {
  var background = _ref207.background;
  return { position: "relative", flex: 1, "&::before": { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", background, content: '""' } };
});
var SwatchColors = styled.div(function(_ref208) {
...
var ListHeading = styled.div(function(_ref209) {
...
var List$1 = styled.div(function(_ref210) {
  var theme = _ref210.theme;
  return { fontSize: theme.typography.size.s2, lineHeight: "20px", display: "flex", flexDirection: "column" };
});
function renderSwatch(color, index3) {
  return import_react.default.createElement(Swatch, { key: "".concat(color, "-").concat(index3), title: color, background: color });
}
function renderSwatchLabel(color, index3, colorDescription) {
  return import_react.default.createElement(SwatchLabel, { key: "".concat(color, "-").concat(index3), title: color }, import_react.default.createElement("div", null, color, colorDescription && import_react.default.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  if (Array.isArray(colors)) {
    return import_react.default.createElement(SwatchSpecimen, null, import_react.default.createElement(SwatchColors, null, colors.map(function(color, index3) {
      return renderSwatch(color, index3);
    })), import_react.default.createElement(SwatchLabels, null, colors.map(function(color, index3) {
      return renderSwatchLabel(color, index3);
    })));
  }
  return import_react.default.createElement(SwatchSpecimen, null, import_react.default.createElement(SwatchColors, null, Object.values(colors).map(function(color, index3) {
    return renderSwatch(color, index3);
  })), import_react.default.createElement(SwatchLabels, null, Object.keys(colors).map(function(color, index3) {
    return renderSwatchLabel(color, index3, colors[color]);
  })));
}
var ColorItem = function ColorItem2(_ref211) {
  var title = _ref211.title, subtitle = _ref211.subtitle, colors = _ref211.colors;
...
var ItemLabel = styled.div(function(_ref212) {
...
var ItemSpecimen = styled.div(function(_ref213) {
...
var IconItem = function IconItem2(_ref214) {
  var name = _ref214.name, children = _ref214.children;
...
***************************************************************************** */
//# sourceMappingURL=chunk-PBKQ6HAR.js.map
