...
var apply, call, uncurryThis, fixRegExpWellKnownSymbolLogic, fails2, anObject, isCallable, isNullOrUndefined, toIntegerOrInfinity, toLength, toString, requireObjectCoercible, advanceStringIndex, getMethod, getSubstitution, regExpExec, wellKnownSymbol3, REPLACE, max, min, concat2, push, stringIndexOf, stringSlice, maybeToString, REPLACE_KEEPS_$0, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE, REPLACE_SUPPORTS_NAMED_GROUPS;
var init_es_string_replace = __esm({
  "node_modules/core-js/modules/es.string.replace.js"() {
    ...
    REPLACE = wellKnownSymbol3("replace");
    max = Math.max;
    min = Math.min;
    concat2 = uncurryThis([].concat);
    ...
    REPLACE_SUPPORTS_NAMED_GROUPS = !fails2(function() {
      var re = /./;
      re.exec = function() {
        var result = [];
        result.groups = { a: "7" };
...
//# sourceMappingURL=chunk-MYJXNO5K.js.map
