...
var require_isUrlRequest = __commonJS({
  "node_modules/loader-utils/lib/isUrlRequest.js"(exports, module) {
    ...
    init_define_import_meta_env();
    var path = (init_path(), __toCommonJS(path_exports));
    function isUrlRequest(url, root2) {
      ...
      if ((root2 === void 0 || root2 === false) && /^\//.test(url)) {
        return false;
      }
      return true;
    }
...
var require_urlToRequest = __commonJS({
  "node_modules/loader-utils/lib/urlToRequest.js"(exports, module) {
    ...
    function urlToRequest(url, root2) {
      if (url === "") {
        return "";
      }
      ...
      if (matchNativeWin32Path.test(url)) {
        request = url;
      } else if (root2 !== void 0 && root2 !== false && /^\//.test(url)) {
        switch (typeof root2) {
          case "string":
            if (moduleRequestRegex.test(root2)) {
              request = root2.replace(/([^~/])$/, "$1/") + url.slice(1);
            } else {
              request = root2 + url;
            }
            break;
          ...
          default:
            throw new Error(
              "Unexpected parameters to loader-utils 'urlToRequest': url = " + url + ", root = " + root2 + "."
            );
        }
      } else if (/^\.\.?\//.test(url)) {
        request = url;
...
var init_big = __esm({
  "node_modules/big.js/big.mjs"() {
    ...
    P.sqrt = function() {
      var r, c2, t, x = this, Big2 = x.constructor, s = x.s, e = x.e, half = new Big2(0.5);
      if (!x.c[0])
        return new Big2(x);
      if (s < 0)
    ...
    P.times = P.mul = function(y) {
      var c2, x = this, Big2 = x.constructor, xc = x.c, yc = (y = new Big2(y)).c, a = xc.length, b = yc.length, i = x.e, j = y.e;
      y.s = x.s == y.s ? 1 : -1;
      if (!xc[0] || !yc[0])
...
var require_getHashDigest = __commonJS({
  "node_modules/loader-utils/lib/getHashDigest.js"(exports, module) {
    ...
    function encodeBufferToBase(buffer2, base) {
      const encodeTable = baseEncodeTables[base];
      if (!encodeTable) {
        throw new Error("Unknown encoding base" + base);
      }
      const readLength = buffer2.length;
      const Big2 = (init_big(), __toCommonJS(big_exports));
      Big2.RM = Big2.DP = 0;
      let b = new Big2(0);
      for (let i = readLength - 1; i >= 0; i--) {
        b = b.times(256).plus(buffer2[i]);
      }
      let output = "";
      while (b.gt(0)) {
    ...
    function getHashDigest(buffer2, hashType, digestType, maxLength) {
